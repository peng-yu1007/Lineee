...
namespace Lineee.Controllers
{
    public class ExaOrdersController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.patient_id = new SelectList(db.Patient, "patient_id", "id_card");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "exam_number,exam_id,patient_id,doctor_id,order_date")] ExaOrders exaOrders)
        {
